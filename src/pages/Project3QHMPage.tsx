    ...
    <div>
      <div className="p-8 m-8">
        <div
          ...
          style={{
            backgroundImage: `url(https://ik.imagekit.io/auewbfj8o/QHM/Header_1_.png)`,
            height: "400px",
          }}
        >
          <div
            ...
            <div className="flex justify-center items-center h-full">
              <div className="text-white content-center">
                ...
                <h4 className="font-semibold text-l w-3/4 mb-6 mx-auto md:text-xl ">
                  A group project to build an actual app for an LGBTQ+
                  non-profit organization in Berlin, with back-end Express.js
                  REST API and a React frontend client app that allow users to
                  perform authentication features and CRUD operation.
                </h4>
                <Link to="HTTPS://QHM-APP.NETLIFY.APP/"> Go to the site</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="m-12">
        ...
        <p>
          HTML, Tailwinds SASS, React, NodeJS, ExpressJS, mongoDB, Google Maps
          api
        </p>
      </div>
